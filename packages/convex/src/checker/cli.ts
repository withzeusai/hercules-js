...
function helpText(): string {
  return [
    ...
    "Permission literals (the `permission` option on query/mutation/action and",
    "the permission argument to iam.can / iam.require) must be a declared app",
    "permission or a system.* permission. Resource-type literals in resource refs",
