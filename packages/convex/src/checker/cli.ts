...
function helpText(): string {
  return [
    ...
    "Permission literals (the `permission` option on accessQuery/accessMutation/",
    "accessAction and the argument to access.can / access.require, a single key or",
    "an anyOf/allOf set) must be a declared app permission.",
